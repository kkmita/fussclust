...
semi-supervised clustering, including fuzzy, possibilistic, and hybrid
models.

## Installation

You can install the development version of `fussclust` from
...
This is a basic example which shows how to fit unsupervised and
